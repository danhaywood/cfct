...
|cfct.webapp.comparison.connection.server
|localhost:14333
|SQL Server host and port shown as the default login server.

|cfct.webapp.comparison.connection.username
|sa
|Default login username shown in the webapp login form.

|cfct.webapp.comparison.connection.password
|change-me
|Default login password shown in the webapp login form.

|cfct.webapp.comparison.connection.left-database
|left_db
|Default source database name used for the left-hand comparison side.

|cfct.webapp.comparison.connection.right-database
|right_db
...
|cfct.webapp.selection-plan.explicit.tables
|[dbo.Supplier]
|Default explicit table list used by the webapp selection plan.
|===
...
The login form is pre-populated from `cfct.webapp.comparison.connection.*` configuration values, and every field remains editable.
