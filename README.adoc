...
Set `CFCT_SQL_TRACE_ENABLED=true` (or JVM system property `-Dcfct.sql.trace.enabled=true`) to emit SQL statements before execution for verification and troubleshooting.
