...
public final class YamlMultiTableComparisonReportRenderer {

    private final ObjectMapper objectMapper;

    public YamlMultiTableComparisonReportRenderer(final ObjectMapper objectMapper) {
    ...
    public String render(final MultiTableComparisonResult result) {
        try {
            return objectMapper.writeValueAsString(toYamlModel(result)) + System.lineSeparator();
        } catch (JsonProcessingException ex) {
            throw new IllegalStateException("Failed to render comparison result as YAML", ex);
        }
    }

    private Map<String, Object> toYamlModel(final MultiTableComparisonResult result) {
