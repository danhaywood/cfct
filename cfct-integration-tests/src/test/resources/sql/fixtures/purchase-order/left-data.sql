...
INSERT INTO causewayExtCommandLog.CommandLogEntry (
    ...
    ('44444444-4444-4444-4444-444444444444', 'FOREGROUND', 'supplier.Supplier#updateContact', '2026-04-05T10:10:00.000', 'supplier.Supplier:302', 'EXPORTED'),
    ('55555555-5555-5555-5555-555555555555', 'FOREGROUND', 'purchaseorder.PurchaseOrder#approve', '2026-04-05T10:20:00.000', 'purchaseorder.PurchaseOrder:101', 'EXPORTED'),
    ('66666666-6666-6666-6666-666666666666', 'FOREGROUND', 'customer.Customer#onboard', '2026-04-05T10:30:00.000', 'customer.Customer:501', 'EXPORTED'),
    ('77777777-7777-7777-7777-777777777777', 'BACKGROUND', 'product.Product#adjustInventory', '2026-04-05T10:40:00.000', 'product.Product:702', 'EXPORTED');
GO
