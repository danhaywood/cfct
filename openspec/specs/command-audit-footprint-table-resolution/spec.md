# command-audit-footprint-table-resolution Specification

## Purpose
TBD - created by archiving change resolve-touched-tables-from-command-audit. Update Purpose after archive.
## Requirements
