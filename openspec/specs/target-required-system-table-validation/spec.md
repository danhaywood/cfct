# target-required-system-table-validation Specification

## Purpose
TBD - created by archiving change validate-target-required-system-tables. Update Purpose after archive.
## Requirements
