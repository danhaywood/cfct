...
The project name should move from `cfct` to `cfct`.
...
Rename project-facing naming from `cfct` to `cfct` across user-visible surfaces.
...
This change affects docs, scripts, and any user-facing labels that still reference `cfct`.
