...
The webapp home page SHALL display configured connection context and SQL connectivity status in a footer.
...
The footer SHALL display the SQL Server identity, left database name, right database name, and current SQL connectivity status.
...
- **THEN** the home page footer displays those configured connection values and SQL connectivity status
