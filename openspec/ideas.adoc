...
cfct.webapp.comparison.connection.right-database: remove the 'comparison' part, ie cfct.webapp.connection.right-database
...
cfct.webapp.comparison.validation.enabled: remove the 'comparison' part, ie cfct.webapp.validation.enabled
cfct.webapp.comparison.validation.fail-fast: remove the 'comparison' part, ie cfct.webapp.validation.fail-fast
