...
* /opsx-propose: remove connectionStatusState and connectionStatusSummary, neither is required.  With comparisonProgressSummary, when either hit clear or change the selection parameters in either table in the nav drawer, then clear any previous status report.
