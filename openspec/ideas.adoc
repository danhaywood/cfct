...
* /opsx-propose: create a docker image out of the webapp, leveraging Spring Boot's layering approach.

* /opsx-propose: add a github action, to push the docker image to docker hub.  Parameterize as necessary for credentials etc, update the README with details of necessary credentials required to be provided.
